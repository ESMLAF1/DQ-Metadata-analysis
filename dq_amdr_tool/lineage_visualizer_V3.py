...
class LineageVisualizer:
    def __init__(self, metadata):
        ...
        self.data_catalogue_colors = pd.DataFrame(data={
            "Type":['Business Term','Conceptual Term','Application','System','Table','Data Element','Control', 'Business Rule'],
            "Color":['firebrick','silver','lightcoral','forestgreen','lightsteelblue','black','gold','purple']})

        # Declaration of shape color mapping
        self.data_catalogue_shapes = pd.DataFrame(data={
            "Type": ['Business Term', 'Conceptual Term', 'Application', 'System', 'Table', 'Data Element', 'Control', 'Business Rule'],
            "Shape": ['dot', 'dot', 'dot', 'diamond', 'square', 'square', 'triangleDown', 'triangleDown']})
    ...
    def create_html_file(self,lineage_graph):
        # Adapts the final html file for the previously created graph
    ...
    def create_node_list(self,input_node):
        ...
        # Full representation, no nodes selected
        if (self.input_node == "None"):
            ...
            # Extracts the filtered list of nodes and edges depending on the relations of the selected node
            self.data_catalogue = []
